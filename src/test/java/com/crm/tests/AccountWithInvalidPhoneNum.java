...
public class AccountWithInvalidPhoneNum {
	...
	@Test(description = "it Creates account with invalid phone number", priority = 0)
	public void createAccountWithoutName() throws IllegalArgumentException, InterruptedException {
		...
		accountService.inesrtPhoneNumber(appData.get(0).getInvalidphonenum());
