...
public class AccountWithoutName {
	...
	@Test(description = "it Creates account without Name", priority = 0)
	public void createAccountWithoutName() throws IllegalArgumentException, InterruptedException {
		...
		// accountService.insertNewAccountName(appData.get(0).getAccountname());
