...
public class LoginTestCase3UP {
	...
	@Test(description = "Login with inValid UserName", priority = 0)
	public void loginWithInvalidUserName() throws InterruptedException {
		loginService.loginToApplication(appData.get(0).getInvalidusername(), appData.get(0).getInvalidpassword());
